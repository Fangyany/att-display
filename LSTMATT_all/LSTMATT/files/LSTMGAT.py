...
if "save_dir" not in config:
    config["save_dir"] = os.path.join(
        root_path, "LSTMGAT_all", model_name
    )
...
config["val_mini_split"] = os.path.join(root_path, "dataset/val_mini/data")
...
config["preprocess_train"] = '/data/zzyu/GraphGAN2/dataset/preprocess/train_crs_dist6_angle90.p'

config["preprocess_val"] = os.path.join(
    root_path,"dataset", "preprocess", "val_crs_dist6_angle90.p"
)
config["preprocess_val_mini"] = os.path.join(
    root_path,"dataset", "preprocess", "val_crs_dist6_angle90_mini.p"
)
